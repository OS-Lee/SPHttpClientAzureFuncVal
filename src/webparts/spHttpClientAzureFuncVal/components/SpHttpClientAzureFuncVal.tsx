...
import { HttpClient, HttpClientResponse, SPHttpClient, ISPHttpClientOptions, SPHttpClientResponse, SPHttpClientConfiguration } from '@microsoft/sp-http';
        ...
        <div className={styles.container}>
          <div className={styles.row}>
            <div className={styles.column}>
              ...
              <div>User Profile--commented:</div>              
